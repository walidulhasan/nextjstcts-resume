  ...
  return (
    <div className="w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4">
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
        ...
        >
          <Image className="w-8" alt="log" src={logo} />
        </motion.div>
        <div className="hidden mdl:inline-flex items-center gap-7">
          <ul className="flex text-[13px] gap-7">
            <Link
              href="#home"
              onClick={handeloScroll}
            ...
            >
              ...
              >
                <span className="text-textGreen">01.</span>Experience
              </motion.li>
            </Link>
            <Link
              onClick={handeloScroll}
            ...
            >
              ...
              >
                <span className="text-textGreen">04.</span>Contract
              </motion.li>
            </Link>
          </ul>
          <Link href="/assets/walidulhasanResume.pdf" target="_blank">
            <motion.button
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ duration: 0.5 }}
            ...
            >
              ...
              <div className="flex flex-col items-center gap-7">
                ...
                <motion.a
                  ...
                  href="mailto:walidulhasanboniamin@gmail.com"
